...
const PreviewButton = () => {
    ...
    const handlePreviewToggle = () => { 
        setState(st => {
            st = (st + 1) % 3;
            window.postMessage({type: "togglePreview", state: st}, "*");
            return st;
        });   
    }

    return html`
    <a onclick=${handlePreviewToggle} class="${state!=0 ? "active" : "inactive"}" title="Preview on mouseover">
        ${state==0 && html`<${PreviewIcon}/>`}
        ${state==1 && html`<${PreviewIcon}/>`}
        ${state==2 && html`<${PreviewMonitorIcon}/>`}
    </a>`;
}
...
const PreviewMonitorIcon = () => html`
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
  <path fill="currentcolor" d="M22.5 95 v-9.125 L28.375 80 H7.5 c-2 0 -3.75 -0.75 -5.25 -2.25 -1.5 -1.5 -2.25 -3.25 -2.25 -5.25 V12.5 c0 -2 0.75 -3.75 2.25 -5.25 C3.75 5.75 5.5 5 7.5 5 h85 c2 0 3.75 0.75 5.25 2.25 1.5 1.5 2.25 3.25 2.25 5.25 v60 c0 2 -0.75 3.75 -2.25 5.25 -1.5 1.5 -3.25 2.25 -5.25 2.25 h-21 l6 5.875 V95 H22.5 Z m-15 -22.5 h85 V12.5 H7.5 v60 Z" stroke-width="0.5"/>
  <path fill="currentcolor" d="M51.53 24.99 c-9.665 0 -17.5 7.835 -17.5 17.5 s7.835 17.5 17.5 17.5 17.5 -7.835 17.5 -17.5 S61.195 24.99 51.53 24.99 Z M51.53 54.99 c-6.905 0 -12.5 -5.595 -12.5 -12.5 s5.595 -12.5 12.5 -12.5 12.5 5.595 12.5 12.5 S58.435 54.99 51.53 54.99 Z M86.195 33.695 c-8.465 -11.445 -20.855 -18.68 -34.69 -18.68 S25.285 22.25 16.82 33.695 c-3.74 5.055 -3.74 12.565 0 17.615 8.465 11.445 20.855 18.68 34.69 18.68 s26.22 -7.235 34.69 -18.68 C89.935 46.26 89.935 38.75 86.195 33.695 Z M82.435 47.165 C74.585 58.495 63.28 65 51.42 65 c-11.85 0 -23.155 -6.505 -31.01 -17.83 -1.87 -2.7 -1.87 -6.62 0 -9.32 7.855 -11.335 19.16 -17.83 31.01 -17.83 11.86 0 23.165 6.5 31.015 17.83 C84.305 40.545 84.305 44.47 82.435 47.165 Z"/>
</svg>`
