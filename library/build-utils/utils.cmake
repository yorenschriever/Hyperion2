...
macro(hyperion_before)
    ...
    if (NOT ("${TARGET}" STREQUAL "macos" OR "${TARGET}" STREQUAL "linux" OR "${TARGET}" STREQUAL "rpi" OR "${TARGET}" STREQUAL "windows"))
        config_esp()
    endif()
endmacro()

macro(hyperion_after)
    if ("${TARGET}" STREQUAL "macos" OR "${TARGET}" STREQUAL "linux" OR "${TARGET}" STREQUAL "rpi" OR "${TARGET}" STREQUAL "windows")
        config_unix()
    endif ()
endmacro()
