...
#include "esp_mac.h"
#include "../esp32/misc/mdns/mdns.h"

static const char *TAG = "ETH";

const gpio_num_t PIN_RMII_OSC_ENABLE = GPIO_NUM_16;
...
void Ethernet::initialize()
{
    ...
    esp_rom_gpio_pad_select_gpio(PIN_RMII_OSC_ENABLE);
    gpio_set_direction(PIN_RMII_OSC_ENABLE, GPIO_MODE_OUTPUT);
    gpio_set_level(PIN_RMII_OSC_ENABLE, 1);
